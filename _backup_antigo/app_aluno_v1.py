...
def salvar_medidas(dados: dict, aluno: Aluno = Depends(get_aluno_logado), db: Session = Depends(get_db)):
    ...
    if not aval or aval.data_avaliacao != hoje:
        ...
        db.add(aval)
    mapa = {
        'torax': 'circ_torax', 'cintura': 'circ_cintura', 'abdomen': 'circ_abdomen',
        'quadril': 'circ_quadril', 'bracoD': 'circ_braco_d_contraido', 'bracoE': 'circ_braco_e_contraido',
        'antebD': 'circ_antebraco_d', 'antebE': 'circ_antebraco_e',
        'coxaD': 'circ_coxa_d', 'coxaE': 'circ_coxa_e',
        'pantD': 'circ_panturrilha_d', 'pantE': 'circ_panturrilha_e'
    }
