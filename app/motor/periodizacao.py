...
EXERCICIOS = {
    ...
    "peito": {
        ...
        "avancado2": [
            {"nome": "Supino Reto com Barra",     "series": 5, "repeticoes": "3-6",   "descanso": 150, "tecnica": "cluster"},
            {"nome": "Supino Inclinado Halteres", "series": 4, "repeticoes": "6-8",   "descanso": 90,  "tecnica": None},
            {"nome": "Supino com Pausa no Peito", "series": 4, "repeticoes": "6-8",   "descanso": 120, "tecnica": "pausa 2s"},
            {"nome": "Dips Paralela com Peso",    "series": 4, "repeticoes": "8-10",  "descanso": 90,  "tecnica": None},
            {"nome": "Crucifixo na Polia",        "series": 4, "repeticoes": "12-15", "descanso": 45,  "tecnica": "drop-set"},
            {"nome": "Crossover",                 "series": 4, "repeticoes": "15-20", "descanso": 30,  "tecnica": "tri-set com Crucifixo e Polia"},
        ],
        "avancado3": [
            {"nome": "Supino Reto com Barra",     "series": 6, "repeticoes": "2-5",   "descanso": 180, "tecnica": "cluster"},
            {"nome": "Supino Inclinado Halteres", "series": 5, "repeticoes": "6-8",   "descanso": 90,  "tecnica": "rest-pause"},
            {"nome": "Larsen Press",              "series": 4, "repeticoes": "5-8",   "descanso": 120, "tecnica": "pausa 2s"},
            {"nome": "Dips Paralela com Peso",    "series": 4, "repeticoes": "6-8",   "descanso": 90,  "tecnica": "rest-pause"},
            {"nome": "Flexao Pliometrica",        "series": 4, "repeticoes": "6-8",   "descanso": 60,  "tecnica": "pliometria"},
    ...
    "costas": {
        ...
        "avancado2": [
            {"nome": "Barra Fixa com Peso",    "series": 5, "repeticoes": "6-8",   "descanso": 120, "tecnica": "cluster"},
            {"nome": "Pendlay Row",            "series": 5, "repeticoes": "4-6",   "descanso": 150, "tecnica": None},
            {"nome": "Remada Curvada",         "series": 4, "repeticoes": "6-8",   "descanso": 120, "tecnica": None},
            {"nome": "Remada Unilateral",      "series": 4, "repeticoes": "8-10",  "descanso": 90,  "tecnica": "rest-pause"},
            {"nome": "Pullover com Halter",    "series": 4, "repeticoes": "10-12", "descanso": 60,  "tecnica": None},
            {"nome": "Puxada Frontal",         "series": 4, "repeticoes": "10-12", "descanso": 60,  "tecnica": "drop-set"},
            {"nome": "Remada Alta",            "series": 4, "repeticoes": "12-15", "descanso": 60,  "tecnica": "tri-set com Puxada e Remada"},
        ],
        "avancado3": [
            {"nome": "Snatch Grip Deadlift",   "series": 5, "repeticoes": "3-5",   "descanso": 240, "tecnica": "cluster"},
            {"nome": "Barra Fixa com Peso",    "series": 5, "repeticoes": "5-8",   "descanso": 120, "tecnica": "piramide crescente"},
            {"nome": "Pendlay Row",            "series": 5, "repeticoes": "3-5",   "descanso": 180, "tecnica": None},
            {"nome": "Remada Unilateral",      "series": 4, "repeticoes": "6-8",   "descanso": 90,  "tecnica": "rest-pause"},
            {"nome": "Pullover com Halter",    "series": 4, "repeticoes": "8-10",  "descanso": 60,  "tecnica": "pre-exaustao"},
    ...
    "ombros": {
        ...
        "avancado2": [
            {"nome": "Push Press",                "series": 5, "repeticoes": "4-6",   "descanso": 120, "tecnica": "cluster"},
            {"nome": "Desenvolvimento com Barra", "series": 5, "repeticoes": "5-8",   "descanso": 90,  "tecnica": None},
            {"nome": "Arnold Press",              "series": 4, "repeticoes": "8-10",  "descanso": 75,  "tecnica": "rest-pause"},
            {"nome": "Elevacao Lateral",          "series": 5, "repeticoes": "12-15", "descanso": 45,  "tecnica": "drop-set"},
            {"nome": "Face Pull",                 "series": 4, "repeticoes": "12-15", "descanso": 45,  "tecnica": None},
            {"nome": "Elevacao Frontal",          "series": 4, "repeticoes": "12-15", "descanso": 60,  "tecnica": "bi-set com Lateral"},
            {"nome": "Remada Alta",               "series": 4, "repeticoes": "12-15", "descanso": 60,  "tecnica": "tri-set"},
        ],
        "avancado3": [
            {"nome": "Push Press",                "series": 6, "repeticoes": "3-5",   "descanso": 180, "tecnica": "cluster"},
            {"nome": "Desenvolvimento com Barra", "series": 5, "repeticoes": "3-6",   "descanso": 120, "tecnica": "piramide decrescente"},
            {"nome": "Arnold Press",              "series": 5, "repeticoes": "6-8",   "descanso": 90,  "tecnica": "rest-pause"},
            {"nome": "Cuban Press",               "series": 4, "repeticoes": "8-10",  "descanso": 60,  "tecnica": None},
            {"nome": "Elevacao Lateral 21s",      "series": 4, "repeticoes": "21",    "descanso": 60,  "tecnica": "21s (7+7+7)"},
            {"nome": "Face Pull",                 "series": 4, "repeticoes": "15",    "descanso": 45,  "tecnica": "bi-set com Lateral"},
            {"nome": "Elevacao Lateral",          "series": 5, "repeticoes": "12-15", "descanso": 45,  "tecnica": "drop-set"},
            {"nome": "Remada Alta",               "series": 4, "repeticoes": "12-15", "descanso": 60,  "tecnica": None},
        ],
    },
    ...
    "pernas": {
        ...
        "avancado2": [
            {"nome": "Back Squat",                  "series": 5, "repeticoes": "3-6",   "descanso": 180, "tecnica": "cluster"},
            {"nome": "Hip Thrust com Barra",        "series": 4, "repeticoes": "6-8",   "descanso": 120, "tecnica": "pausa 2s no topo"},
            {"nome": "Stiff",                       "series": 4, "repeticoes": "5-8",   "descanso": 90,  "tecnica": None},
            {"nome": "Step Up no Smith",            "series": 4, "repeticoes": "8 cada","descanso": 75,  "tecnica": None},
            {"nome": "Afundo Bulgaro",              "series": 4, "repeticoes": "8 cada","descanso": 75,  "tecnica": "rest-pause"},
            {"nome": "Cadeira Extensora",           "series": 4, "repeticoes": "12-15", "descanso": 60,  "tecnica": "drop-set"},
            {"nome": "Mesa Flexora",                "series": 4, "repeticoes": "10-12", "descanso": 60,  "tecnica": "rest-pause"},
            {"nome": "Panturrilha em Pe",           "series": 5, "repeticoes": "15-20", "descanso": 45,  "tecnica": "drop-set"},
        ],
        "avancado3": [
            {"nome": "Back Squat",                  "series": 6, "repeticoes": "2-5",   "descanso": 240, "tecnica": "cluster"},
            {"nome": "Deadlift Convencional",       "series": 5, "repeticoes": "3-5",   "descanso": 240, "tecnica": "piramide crescente"},
            {"nome": "Hip Thrust com Barra",        "series": 5, "repeticoes": "5-8",   "descanso": 120, "tecnica": "pausa 2s no topo"},
            {"nome": "Agachamento Frente",          "series": 4, "repeticoes": "4-6",   "descanso": 150, "tecnica": None},
            {"nome": "Box Jump",                    "series": 4, "repeticoes": "5",     "descanso": 120, "tecnica": "pliometria"},
            {"nome": "Step Up no Smith",            "series": 4, "repeticoes": "8 cada","descanso": 75,  "tecnica": None},
            {"nome": "Afundo Bulgaro com Pausa",    "series": 4, "repeticoes": "6 cada","descanso": 90,  "tecnica": "pausa 2s no fundo"},
