...
class AvaliacaoFisica(Base):
    ...
    postura_cabeca = Column(String(100))
    postura_ombros = Column(String(100))
    postura_coluna = Column(String(100))
    postura_quadril = Column(String(100))
    postura_joelhos = Column(String(100))
    postura_pes = Column(String(100))
